<div class="breadcrumbs">
    <div class="pull-right">
        <?php if ($html && isset($source)): ?>
            <a href="javascript:;" class="btn btn-xs btn-default" id="toggle">Afficher la source</a>
        <?php endif ?>
        <?php if (ENABLE_PASTEBIN): ?>
            <a href="javascript:;" class="btn btn-xs btn-default" id="create-pastebin" title="Create public Paste on PasteBin">Create public Paste</a>
        <?php endif; ?>
    </div>    
