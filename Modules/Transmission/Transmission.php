	...
	protected function moduleGestion(){
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				...
				$form->addField(new Int('dlSpeed', $settings->getDlSpeed(true), 'Vitesse de téléchargement <span class="glyphicon glyphicon-arrow-down tooltip-bottom" title="Sens descendant"></span>', null, 'Bande passante maximum allouée aux téléchargements, en ko/s. Cette bande passante ne doit pas excéder 80% de votre bande passante descendante ADSL ou Fibre.', new Pattern('number', true), true, 'admin'));
				$form->addField(new Int('upSpeed', $settings->getUpSpeed(true), 'Vitesse de partage <span class="glyphicon glyphicon-arrow-up tooltip-bottom" title="Sens montant"></span>', null, 'Bande passante maximum allouée au partage (sens montant), en ko/s. Cette bande passante ne doit pas excéder 80% de votre bande passante montante ADSL ou Fibre.', new Pattern('number', true), true, 'admin'));
